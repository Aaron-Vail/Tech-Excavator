...
INSERT INTO plant (scientific_name, common_name, price_per_plant, area_per_plant, desired_light, image_link, planting_directions, region) VALUES ('Brassica eruca', 'Arugula', '0.07', '1', 'sun', 'https://cdn.pixabay.com/photo/2016/05/05/15/11/rocket-1374096_960_720.jpg',
 'Grown as an edible herb in the Mediterranean area since Roman times, it was mentioned by various classical authors as an aphrodisiac,[11][12] most famously 
 in a poem long ascribed to Virgil, Moretum, which contains the line: “et Venerem revocans eruca morantem” (“and the rocket, which revives drowsy Venus 
 [sexual desire]”).[13] Some writers assert that for this reason during the Middle Ages it was forbidden to grow rocket in monasteries.[14] It was listed, 
 however, in a decree by Charlemagne of 802 as one of the pot herbs suitable for growing in gardens.', '3');

INSERT INTO plant (scientific_name, common_name, price_per_plant, area_per_plant, desired_light, image_link, planting_directions, region) VALUES ('Oleracea',
 'Kale', '0.08', '2', 'sun', 'https://cdn.pixabay.com/photo/2015/03/26/09/40/plant-690051_960_720.jpg', 'Until the end of the Middle Ages, kale was one of the
  most common green vegetables in Europe. Curly-leaved varieties of cabbage already existed along with flat-leaved varieties in Greece in the fourth century BC.
   It was also used as medicinal food source. Disocorides wrote that it could be used to treat bowel ailments.[3] These forms,
